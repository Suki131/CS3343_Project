...
public class testCmdViewVehicleRecordEmptyInput extends inputOctopusAlipayCredit {
    ...
    @ParameterizedTest
    @MethodSource("viewVehicleRecordEmptyInput")
    void shouldViewVehicleRecordEmptyInput(String simulatedInput, String[] expectedOutputs) {
    ...
    static Stream<Arguments> viewVehicleRecordEmptyInput() {
        return Stream.of(
            Arguments.of(
                "\n",
                new String[] {
