...
public class testCmdViewVehicleRecordWhitespaceInput extends inputOctopusAlipayCredit {
    ...
    @ParameterizedTest
    @MethodSource("viewVehicleRecordWhitespaceInput")
    void shouldViewVehicleRecordWhitespaceInput(String simulatedInput, String[] expectedOutputs) {
    ...
    static Stream<Arguments> viewVehicleRecordWhitespaceInput() {
        return Stream.of(
            Arguments.of(
                "   \n",
                new String[] {
